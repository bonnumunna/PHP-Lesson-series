...
?>
    ...
    <body>
        <header>
            <h1>Sending Mails With PHP mail() Function</h1>
            <h4>By Faculty Bonn</h4>
            <h5>July 25th, 2022</h5>
        </header>
        <div class="container">
            <form action="index.php" method="post">
                ...
                <div>
                    <label for="subuject">Subject</label>
                    <input type="text" name="subject" id="" placeholder="enter subject" value="<?php echo isset($subject)? $subject: ''; ?>">
                </div>
                <div>
                    <textarea name="message" id="" cols="30" rows="10" placeholder="enter message"> <?php echo isset($name)? $name: ''; ?></textarea>
                </div>
